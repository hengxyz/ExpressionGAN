...
class ExprGAN(object):
    ...
    def gen_im(self, images, names=None):
        ...
        for file in names:
            for i in range(self.y_dim):
	        save_file = file+'_%d'%i
                save_files.append(save_file) 
	
	#save_single_images(batch_images=G, save_path=test_dir, save_files, self.image_value_range)
    ...
    def gen_images(self, testing_samples_dir, random_seed):
	    ...
	    self.gen_im(images, sample_files)
