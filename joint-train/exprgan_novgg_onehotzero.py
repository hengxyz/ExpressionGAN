...
class ExprGAN(object):
    ...
    def train(self,
        ...
        if self.is_stage_one:
            ...
            self.loss_EG = self.EG_loss + self.fm_coeff * self.fm_loss + \
        ...
        for epoch in range(num_epochs):
            ...
            for ind_batch in range(num_batches):
                ...
                _, _, _, EG_err, Ez_err, Dz_err, Dzp_err, Gi_err, DiG_err, Di_err, TV, fm_err, DG_cont_err= self.session.run(
                    fetches=[
                        self.EG_optimizer,
                        self.D_z_optimizer,
                ...
                print("\nEpoch: [%3d/%3d] Batch: [%3d/%3d]\n\tEG_err=%.4f\tTV=%.4f\tfmm_err=%.4f" %
                    (epoch+1, num_epochs, ind_batch+1, num_batches, EG_err, TV,  fm_err))
